    ...
    return (
        <div className="flex h-screen w-screen overflow-hidden">
            <div
                ...
                style={{
                    backgroundImage: "url('ryde-signin-signup-page.png')",
                }}
            >
                ...
                <div className="relative z-10 max-w-2xl">
                    ...
                    <h2 className="text-4xl font-bold mb-4 leading-tight">
                        Create your account. <br /> Admin access only.
                    </h2>
                    <p className="text-lg text-white/80 mb-12">
                        Register as an admin using the referral code. Passenger and driver signups are available on the mobile app.
                    </p>
            ...
            <div className="flex-none w-full lg:w-[500px] bg-white flex items-center justify-center p-8 overflow-y-auto">
                <div className="w-full max-w-sm">
                    <h2 className="text-2xl font-bold text-gray-900 mb-6 mt-14">Admin Sign up</h2>
                        ...
                        <div className="mb-4">
                            ...
                            <div className="relative">
                                ...
                                <button
                                    ...
                                    className="absolute right-3 top-1/2 -translate-y-1/2 bg-transparent border-none cursor-pointer text-gray-500 hover:text-gray-700 p-0.5"
